...
Shared block-job state probe for disks, gating commits and snapshot creation on an idle
block job. qsnap observes and defers on active/unknown jobs — it never aborts them.
