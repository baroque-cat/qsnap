...
Groups backups by their FULL anchor chain and evaluates retention at the chain level. Each chain (FULL + all incrementals) is treated as an atomic unit — either entirely kept or entirely removed. Eliminates ghost-retention and cascade-deletion complexity.
