...
- **THEN** the XML is modified: `<name>` changed to "myvm-clone", new `<uuid>` generated, `<source file="...">` updated to the new disk path
...
The forked VM SHALL receive a newly generated UUID via `uuidgen` (or `uuid.uuid4()`). It SHALL NOT reuse the source VM's UUID.
